...
/**
 * Feedback policy that shows vertex handles on figures
 */
export class VertexSelectionFeedbackPolicy extends SelectionFeedbackPolicy {
  /**
   * Creates a vertex selection feedback policy
   * 
