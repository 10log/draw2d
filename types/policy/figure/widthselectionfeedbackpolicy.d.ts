...
/**
 * Feedback policy that shows a selection with customizable width around the figure
 */
export class WidthSelectionFeedbackPolicy extends SelectionFeedbackPolicy {
  /**
   * Creates a width-based selection feedback policy
   * 
