...
/**
 * A specialized connection for UML inheritance relationships.
 * This connection has a triangle decoration at the target end.
 */
export class InheritanceConnection extends Connection {
  /**
   * Creates a new inheritance connection
