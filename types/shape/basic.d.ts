 ...
 * An oval shape
 */
export class Oval extends Figure {
  /**
   * Creates a new oval
...
export class Diamond extends Figure {
   ...
   * @param attr Optional attributes for the diamond
   */
  constructor(attr?: any);
}
...
export class Arc extends Figure {
  /**
   * Creates a new arc
   * @param attr Optional attributes for the arc
   */
  constructor(attr?: any);
}
...
export namespace basic {
  export { Rectangle, Circle, Line, Label, Text, Image, Oval, Diamond, Arc, PolyLine, Polygon };
}
